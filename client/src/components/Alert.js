...
export default function Alert({ show, message, type }) {
    ...
    return ( // d-none
        <div class="alert alert-danger d-flex align-items-center" role="alert" style={{ width: '50%', position: 'absolute', right: 10, top: state.alert.show ? 10 : -100, transition: '0.5s', gap:30 }}>
